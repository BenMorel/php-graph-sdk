...
class OAuth2Client
{
     ...
     */
    protected const BASE_AUTHORIZATION_URL = 'https://www.facebook.com';
     ...
     * @throws FacebookSDKException
     */
    public function getCodeFromLongLivedAccessToken(AccessToken|string $accessToken, string $redirectUri = ''): AccessToken|string
    {
        $params = [
            'redirect_uri' => $redirectUri,
        ];
     ...
     */
    protected function sendRequestWithClientParams(string $endpoint, array $params, AccessToken|string|null $accessToken = null): FacebookResponse
    {
